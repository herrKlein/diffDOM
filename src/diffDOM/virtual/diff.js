...
export class DiffFinder {
    constructor(t1Node, t2Node, options) {
        ...
        this.t1 = (typeof HTMLElement !== 'undefined' && t1Node instanceof Element) ? nodeToObj(t1Node, this.options) : (typeof t1Node === 'string') ? stringToObj(t1Node, this.options) : JSON.parse(JSON.stringify(t1Node))
        this.t2 = (typeof HTMLElement !== 'undefined' && t2Node instanceof Element) ? nodeToObj(t2Node, this.options) : (typeof t2Node === 'string') ? stringToObj(t2Node, this.options) : JSON.parse(JSON.stringify(t2Node))
        this.diffcount = 0
        this.foundAll = false
        if (this.debug) {
